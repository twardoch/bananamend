/* @ts-self-types="./bananamendr.d.ts" */
...
export class Model {
    ...
    applyChatTemplate(messages) {
        ...
        let deferred2_1;
        try {
            const ret = wasm.model_applyChatTemplate(this.__wbg_ptr, messages);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @param {any} messages
     * @param {any} options
     * @param {Function | null} [on_token]
     * @returns {any}
     */
    chat(messages, options, on_token) {
        const ret = wasm.model_chat(this.__wbg_ptr, messages, options, isLikeNone(on_token) ? 0 : addToExternrefTable0(on_token));
        if (ret[2]) {
     ...
     */
    chatTokens(messages) {
        const ret = wasm.model_chatTokens(this.__wbg_ptr, messages);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
     ...
     * @returns {string}
     */
    detokenize(tokens, skip_special_tokens) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passArray32ToWasm0(tokens, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.model_detokenize(this.__wbg_ptr, ptr0, len0, skip_special_tokens);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @param {string | null | undefined} tokenizer_config_json
     * @param {Uint8Array} weights
     * @returns {Model}
     */
    static fromParts(config_json, tokenizer_json, tokenizer_config_json, weights) {
        const ptr0 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(tokenizer_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        var ptr2 = isLikeNone(tokenizer_config_json) ? 0 : passStringToWasm0(tokenizer_config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ptr3 = passArray8ToWasm0(weights, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.model_fromParts(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     * @returns {any}
     */
    generate(prompt, options, on_token) {
        const ptr0 = passStringToWasm0(prompt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.model_generate(this.__wbg_ptr, ptr0, len0, options, isLikeNone(on_token) ? 0 : addToExternrefTable0(on_token));
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    info() {
        const ret = wasm.model_info(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    logits(text) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.model_logits(this.__wbg_ptr, ptr0, len0);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
    ...
    tokenize(text) {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.model_tokenize(this.__wbg_ptr, ptr0, len0);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('bananamendr_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
